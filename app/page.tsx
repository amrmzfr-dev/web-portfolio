      ...
      <section id="projects">
        ...
        <div className="projects-grid">
          ...
          <Link href="/projects/cctv" className="proj-card fade-up" style={{ '--delay': '0.1s' } as React.CSSProperties}>
            ...
            <div className="proj-card-desc">Python REST API over Dahua&apos;s C NetSDK for in-charger CCTV on our EV units, integrated by an agency into an OEM consumer app.</div>
            <div className="proj-card-tags">
