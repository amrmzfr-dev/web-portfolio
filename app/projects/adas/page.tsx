        ...
        <div className="proj-content">
          <div className="proj-main">
            ...
            <div className="content-block">
              ...
              <p className="content-text">The project is in active R&amp;D with the supplier confirmed for the pilot phase. The focus right now is on validating the core detection pipeline before moving to field testing. More details will be available after the pilot.</p>
            </div>
