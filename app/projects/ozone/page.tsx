        ...
        <div className="proj-content">
          <div className="proj-main">
            ...
            <div className="content-block">
              ...
              <p className="content-text" style={{ marginTop: '1rem' }}>First: phantom counts. The optocoupler in the previous design was susceptible to electrical noise generated by the machine&apos;s own relay switching. A single physical session would bounce 2 to 3 times and register as multiple treatments. I addressed this at the firmware level with debounce logic and clean edge detection on the ESP32. Each physical session trigger maps to exactly one record, regardless of signal noise.</p>
          ...
          <div className="proj-sidebar">
            ...
            <div className="sidebar-block">
              ...
              <div className="sidebar-val">Clock integrity architecture with timestamps persisted in NVS. Signal debounce eliminating phantom counts. Live billing in production.</div>
            </div>
          </div>
        </div>
